...
const LABELS: Record<StubPage, string> = {
...
export default function LegacyPageStub({ page }: { page: LegacyPage }) {
  ...
  return (
    <main className="checkpoint-stub">
      <div className="checkpoint-stub-brand">
        Edu Share<span>+</span>
      </div>
      ...
      <p>
        Route này đã được bảo toàn trong shell local và sẽ được port nguyên giao
        diện/logic ở checkpoint tiếp theo của Phase 1.
      </p>
