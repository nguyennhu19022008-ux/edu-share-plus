...
**Phase 3A provisional authorization requirements.**
...
A future account may hold more than one staff capability; final role storage is decided in the ERD.
...
## To finalize during Phase 3B/3C

- exact role/capability tables;
- account approval policy;
- staff assignment scope by school;
- RLS policy expressions;
- ownership rules for retained legacy posts;
