...
**Phase 3C physical-schema/RLS-aligned authorization requirements. RLS policies are still design-only and not yet implemented.**
...
## To finalize during live implementation/testing
